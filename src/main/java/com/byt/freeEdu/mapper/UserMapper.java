...
public interface UserMapper{
  ...
  @Mapping(target = "id", source = "userId")
  @Mapping(target = "role", source = "userRole", qualifiedByName = "translateRole")
  @Mapping(target = "parentId", expression = "java(student.getParent() != null ? student.getParent().getUserId() : 0)")
  @Mapping(target = "schoolClassId", expression = "java(student.getSchoolClass() != null ? student.getSchoolClass().getSchoolClassId() : 0)")
  @Mapping(target = "contactInfo", ignore = true)
