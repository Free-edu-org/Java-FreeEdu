...
import com.byt.freeEdu.service.users.AdminService;
...
public class ViewControllerAdmin{
  ...
  public ViewControllerAdmin(SessionService sessionService, UserService userService,
      UserMapper userMapper, ScheduleService scheduleService, GradeService gradeService,
      SchoolClassService schoolClassService, StudentService studentService,
      AttendanceService attendanceService, RemarkService remarkService,
      TeacherService teacherService, GradeMapper gradeMapper, ParentService parentService,
  ...
  public String editScheduleFormConfirm(@PathVariable int id,
  ...
  public String getSchoolClasses(Model model) {
    ...
    for (SchoolClass schoolClass : schoolClasses) {
      List<StudentDto> students = studentService
          .getStudentsBySchoolClassId(schoolClass.getSchoolClassId());
  ...
  public String changeStudentClassFormConfirm(@PathVariable("studentId") int studentId,
      @PathVariable("schoolClassId") int schoolClassId) {
    studentService.changeStudentClass(studentId,
        schoolClassService.getSchoolClassById(schoolClassId));
    return "redirect:/view/admin/schoolClass";
  }
  ...
  public String editAttendance(@PathVariable("id") int attendanceId,
