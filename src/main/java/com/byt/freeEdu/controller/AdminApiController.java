...
public class AdminApiController{
  ...
  public Flux<Map<String, Object>> teachers() {
    return Flux
        .fromIterable(teacherService
            .getAllTeachers().stream().map(t -> Map.<String, Object>of("userId",t.getUserId(),
  ...
  public Flux<Map<String, Object>> students() {
    return Flux
        .fromIterable(studentService
            .getAllStudents().stream().map(s -> Map.<String, Object>of("userId",s.getUserId(),
  ...
  public Flux<Map<String, Object>> listRemarks() {
    return Flux.fromIterable(remarkService.getAllRemarks().stream()
  ...
  public Flux<Map<String, Object>> grades() {
    return Flux.fromIterable(gradeService.getAllGrades().stream().map(dto -> {
