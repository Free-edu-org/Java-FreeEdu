...
class UserServiceTest {
    ...
    public void getAllUsers_returnsListOfUsers() {
        //given
        User user1 = new User("user1", "John", "Doe", "john.doe@example.com", "password", UserRole.UNKNOWN);
        User user2 = new User("user2", "Alice", "Smith", "alice.smith@example.com", "password", UserRole.UNKNOWN);
    ...
    public void addUser_savesUserSuccessfully() {
        ...
        User user = new User("unique", "John", "Doe", "john.doe@example.com", hashedPassword, UserRole.UNKNOWN);
    ...
    public void updateUser_updatesUserSuccessfully() {
        //given
        int userId = 1;
        User existingUser = new User("user1", "John", "Doe", "john.doe@example.com", "password", UserRole.UNKNOWN);
        UserDto updatedUser = new UserDto();
